...
def get_args():
    ...
    # Training Arguments
    parser.add_argument('--max-timesteps', type=int, default=int(1e6), metavar='STEPS',
                        help='Number of training steps')
    parser.add_argument('--max-episode-length', type=int, default=10000, metavar='LENGTH',
                        help='Maximum episode length')
    parser.add_argument('--memory-capacity', type=int, default=100000, metavar='CAPACITY',
                        help='Maximum memory capacity')
    parser.add_argument('--train-freq', type=int, default=1, metavar='N',
    ...
    parser.add_argument('--load_model', type=str, metavar='PARAMS',
